...
public class MyCustomAdapter extends ArrayAdapter {
    ...
    public MyCustomAdapter(@NonNull Context context, int resource, @NonNull List
            objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.displayName = (TextView)
                    convertView.findViewById(R.id.displayName);
            holder.phoneNumber = (TextView)
